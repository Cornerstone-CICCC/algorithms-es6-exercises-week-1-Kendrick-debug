...
const accadamicBackground = "a Master's degree"
let averageSalary;

switch (accadamicBackground) {
...
console.log(`In 2015, a person with ${accadamicBackground} earned an average of $${averageSalary} / year.`)
